...
function createScene() {
  ...
  // --- Planet One ---
  H_028 = BABYLON.MeshBuilder.CreateSphere(
    "sphere",
    { diameter: 0.3 },
    scene
  );
  ...
  H_028Material.emissiveTexture = new BABYLON.Texture("textures/h-028.jpeg", scene);
  ...
  // --- Planet Two ---
  Asiaq = BABYLON.MeshBuilder.CreateSphere(
    "sphere",
    { diameter: 3 },
    scene
  );
  ...
  AsiaqMaterial.emissiveTexture = new BABYLON.Texture("textures/Asiaq.jpeg", scene);
  ...
  // --- Planet Three ---
  Efaja = BABYLON.MeshBuilder.CreateSphere(
    "sphere",
    { diameter: 0.7 },
    scene
  );
  ...
  EfajaMaterial.emissiveTexture = new BABYLON.Texture("textures/Efaja.jpeg", scene);
  ...
  // --- Planet Four ---
  Grill = BABYLON.MeshBuilder.CreateSphere(
    "sphere",
    { diameter: 1.5 },
    scene
  );
  ...
  GrillMaterial.emissiveTexture = new BABYLON.Texture("textures/Grill.jpeg", scene);
  ...
  Habitat7Material.emissiveTexture = new BABYLON.Texture("textures/Habitat_7.jpeg", scene);
  ...
  YhraenMaterial.emissiveTexture = new BABYLON.Texture("textures/Yhraen.jpeg", scene);
